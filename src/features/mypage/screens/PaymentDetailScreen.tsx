    ...
    <SafeAreaView className="flex-1 bg-zinc-50">
      <MypageFrame>
        ...
        >
          ...
          <View className="mt-4">
            <CardSection>
              <Text className="mb-4 text-lg font-bold text-slate-950">결제 정보</Text>
          ...
          <View className="mt-4">
            <CardSection>
              <Text className="mb-4 text-lg font-bold text-slate-950">판매자정보</Text>
          ...
          <View className="mt-4">
            <CardSection>
              <Text className="mb-4 text-lg font-bold text-slate-950">금액 정보</Text>
              ...
              <View className="flex-row items-center justify-between py-2">
                <Text className="text-lg font-bold text-slate-950">최종결제금액</Text>
                <Text className="text-2xl font-bold text-blue-800">33,020원</Text>
              </View>
            </CardSection>
          </View>
...
function ReceiptModal() {
  return (
    <View className="absolute inset-0 items-center justify-center bg-black/55 px-4">
      <View className="w-full rounded-xl bg-white px-6 py-7">
        ...
        <Text className="mb-4 text-lg font-bold text-slate-950">판매자상호 및 정보</Text>
        <InfoRow label="판매자상호" value="코보문고 양정점" />
        <InfoRow label="사업자번호" value="123-45-67890" />
        <InfoRow label="사업자주소" value="서울 마포구 양정길 양정역 앞" />
        <InfoRow label="대표자명" value="나사장" />
        <InfoRow label="전화번호" value="02-987-7654" />
        <View className="my-5 h-px bg-red-400" />
        <InfoRow label="상품금액" value="34,000원" />
        <InfoRow label="할인금액" value="-4,070원" valueClassName="text-red-500" />
        <InfoRow label="부가세" value="3,090원" />
